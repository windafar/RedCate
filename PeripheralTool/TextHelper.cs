...
namespace PeripheralTool
{
    public class TextHelper
    {
        static public IEnumerable<Token> Segmenter(string str)
        {
            ...
            return jiebaSegmenter.Tokenize(str, TokenizerMode.Default);
...
, "ISO 2022CN", "UTF-8", "Unicode", "ASCII", "OTHER"
            ...
            protected virtual Encoding GetEncoding(string encodingName)
            {
           ...
           static BeforeEncodingClass()
            ...
            public static string GetText(byte[] buff)
            {
                ...
                if (buff.Length > 3)
                {
                    ...
                    {
                        IdentifyEncoding ide = new IdentifyEncoding();
                        string ename = ide.GetEncodingName(IdentifyEncoding.ToSByteArray(buff));
                        if (ename == "OTHER") ename = "gb2312";
                         strReslut =Encoding.GetEncoding(ename).GetString(buff);
                    }
                }
